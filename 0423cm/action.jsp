...
switch(action){
	...
	case "insert_res":
		...
		pstmt = conn.prepareStatement(query);
        pstmt.setString(1, request.getParameter("r_seq"));
        pstmt.setString(2, request.getParameter("r_cust_no"));
        pstmt.setString(3, request.getParameter("r_movie_cd"));
        pstmt.setString(4, request.getParameter("morning_fg"));
        s1 = "예매등록이";
}
