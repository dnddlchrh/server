...
<%
query = " select ";
query += " a.sale_pizza_cd,b.pizza_nm, '₩'||sum(a.sale_cnt*b.price) as price ";
query += " from ";
query += " sale_tbl_001 a, pizza_tbl_002 b";
query += " where ";
query += " a.sale_pizza_cd = b.pizza_cd ";
query += " group by";
query += " a.sale_pizza_cd, b.pizza_nm";
pstmt = conn.prepareStatement(query);
res = pstmt.executeQuery();
%>
	<div class="section">
	<div class="tit_comm">상품별 매출 현황</div>
